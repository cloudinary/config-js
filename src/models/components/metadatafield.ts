 ...
 * The type of the metadata field.
 */
export type MetadataFieldType = ClosedEnum<typeof MetadataFieldType>;
...
/** @internal */
export const MetadataFieldType$inboundSchema: z.ZodNativeEnum<
  typeof MetadataFieldType
> = z.nativeEnum(MetadataFieldType);

/** @internal */
export const MetadataFieldType$outboundSchema: z.ZodNativeEnum<
  typeof MetadataFieldType
> = MetadataFieldType$inboundSchema;
...
export namespace MetadataFieldType$ {
  /** @deprecated use `MetadataFieldType$inboundSchema` instead. */
  export const inboundSchema = MetadataFieldType$inboundSchema;
  /** @deprecated use `MetadataFieldType$outboundSchema` instead. */
  export const outboundSchema = MetadataFieldType$outboundSchema;
}
...
export const MetadataField$inboundSchema: z.ZodType<
  ...
  unknown
> = z.object({
  type: MetadataFieldType$inboundSchema,
  external_id: z.string().optional(),
  label: z.string(),
...
export const MetadataField$outboundSchema: z.ZodType<
  ...
  MetadataField
> = z.object({
  type: MetadataFieldType$outboundSchema,
  externalId: z.string().optional(),
  label: z.string(),
  mandatory: z.nullable(z.boolean()).optional(),
