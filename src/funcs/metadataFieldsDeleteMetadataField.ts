...
export function metadataFieldsDeleteMetadataField(
  ...
  Result<
    operations.DeleteMetadataFieldResponse,
    | errors.ApiError
...
> {
  const input: operations.DeleteMetadataFieldRequest = {
  ...
  const parsed = safeParse(
    input,
    (value) =>
      operations.DeleteMetadataFieldRequest$outboundSchema.parse(value),
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.DeleteMetadataFieldResponse$inboundSchema),
