...
export function uploadMappingsUpdateUploadMapping(
  ...
  Result<
    operations.UpdateUploadMappingResponse,
    | errors.ApiError
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.UpdateUploadMappingRequest$outboundSchema.parse(value),
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.UpdateUploadMappingResponse$inboundSchema),
