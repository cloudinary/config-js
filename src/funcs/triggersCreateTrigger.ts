...
> {
  const parsed = safeParse(
    request,
    (value) => operations.CreateTriggerRequest$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/v1_1/{cloud_name}/triggers")(pathParams);
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(201, components.TriggerInfo$inboundSchema),
