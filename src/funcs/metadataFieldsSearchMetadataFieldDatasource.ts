...
export function metadataFieldsSearchMetadataFieldDatasource(
  ...
  Result<
    Array<operations.SearchMetadataFieldDatasourceResponse>,
    | errors.ApiError
    | SDKError
    | SDKValidationError
    | UnexpectedClientError
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.SearchMetadataFieldDatasourceRequest$outboundSchema.parse(
        value,
      ),
  ...
  >(
    M.json(
      200,
      z.array(operations.SearchMetadataFieldDatasourceResponse$inboundSchema),
    ),
