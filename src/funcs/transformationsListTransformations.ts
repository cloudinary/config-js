...
> {
  const input: operations.ListTransformationsRequest = {
    named: named,
  ...
  const parsed = safeParse(
    input,
    (value) =>
      operations.ListTransformationsRequest$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/v1_1/{cloud_name}/transformations")(pathParams);
