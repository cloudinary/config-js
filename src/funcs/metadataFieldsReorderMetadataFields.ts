...
export function metadataFieldsReorderMetadataFields(
  ...
  Result<
    operations.ReorderMetadataFieldsResponse,
    | errors.ApiError
    | SDKError
    | SDKValidationError
    | UnexpectedClientError
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.ReorderMetadataFieldsRequest$outboundSchema.parse(value),
  ...
  const [result] = await M.match<
    ...
    | ConnectionError
  >(
    M.json(200, operations.ReorderMetadataFieldsResponse$inboundSchema),
