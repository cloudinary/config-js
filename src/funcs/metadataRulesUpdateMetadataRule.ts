...
export function metadataRulesUpdateMetadataRule(
  ...
  Result<
    components.MetadataRuleResponse,
    | errors.ApiError
...
> {
  const input: operations.UpdateMetadataRuleRequest = {
  ...
  const parsed = safeParse(
    input,
    (value) => operations.UpdateMetadataRuleRequest$outboundSchema.parse(value),
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, components.MetadataRuleResponse$inboundSchema),
