...
export function transformationsUpdateTransformation(
  ...
  Result<
    operations.UpdateTransformationResponse,
    | errors.ApiError
...
> {
  const input: operations.UpdateTransformationRequest = {
  ...
  const parsed = safeParse(
    input,
    (value) =>
      operations.UpdateTransformationRequest$outboundSchema.parse(value),
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.UpdateTransformationResponse$inboundSchema),
