...
export function metadataRulesDeleteMetadataRule(
  ...
  Result<
    operations.DeleteMetadataRuleResponse,
    | errors.ApiError
...
> {
  const input: operations.DeleteMetadataRuleRequest = {
    externalId: externalId,
  };

  const parsed = safeParse(
    input,
    (value) => operations.DeleteMetadataRuleRequest$outboundSchema.parse(value),
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.DeleteMetadataRuleResponse$inboundSchema),
